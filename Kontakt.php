        ...
        <div class="container-xxl py-6 ">
            <div class="container h-100">
                <div class="row g-5  " style="margin-bottom: 100px;">
                    ...
                    <div class="col-lg-6 wow fadeInUp " data-wow-delay="0.5s">
                        <h4 class="text-start mb-4 float-start fs-6 text-light">KONTAKT US <p class="text-light fs-6 mt-4">Ihre Meinung ist uns wichtig. Ob es sich um eine einfache Frage oder eine wertvolle Anregung handelt, wir sind für Sie da. Sie können uns telefonisch kontaktieren oder uns direkt eine E-Mail schicken.</p>
